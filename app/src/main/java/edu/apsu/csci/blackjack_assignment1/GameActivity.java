...
implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.imageButton1 || view.getId() == R.id.imageButton2 || view.getId() == R.id.imageButton3) {
            ...
            EditText etSame = (EditText) findViewById(R.id.editText);
            String etSameString = etSame.getText().toString();
            int etSameInt = Integer.parseInt(etSameString);
            ...
            if (etInt == 0) {
                ...
                if (et2Int == 0) {
                    ...
                    if (getRandomBoolean()) {
                        Log.d("BABALAFULAAAAAAAAAAAAA", "Value: " + et2String);
                        ...
                        iv11.setImageResource(R.drawable.red_grid_card);
                        iv12.setImageResource(R.drawable.red_grid_card);
                        etSameInt = etSameInt + et2Int;
                        cardValue = etSameInt;
                        etSame.setText(cardValue.toString());
                        counter = 0;
                        cardValue = 0;
                        et.setText(cardValue.toString());
